...
void Game::Init(HWND hWnd, float width, float height)
{
	...
	D3D11_INPUT_ELEMENT_DESC inputTextureElem[] =
	{
		...
		{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, offsetof(VertexPosColorUV, texCoord), D3D11_INPUT_PER_VERTEX_DATA, 0}
	};
...
{
	static float rotationVariable = 1.0;
